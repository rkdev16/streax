...
//            CameraKitLocalizedString(key: "camera_kit_adjustment_tone", comment: "")
            case .portrait: return "Portrait"
//             CameraKitLocalizedString(key: "camera_kit_adjustment_portrait", comment: "")
            }
        }
    }
    ...
    public let secondaryLabel: UILabel = {
        ...
        label.text = "Active"
//        CameraKitLocalizedString(key: "camera_kit_adjustment_active", comment: "")
        label.translatesAutoresizingMaskIntoConstraints = false
    ...
    private lazy var intensitySlider: ControlSlider = {
        ...
        slider.accessibilityLabel = "Adjustment Intensity Slider"
//        CameraKitLocalizedString(key: "camera_kit_adjustment_intensity_slider", comment: "")
