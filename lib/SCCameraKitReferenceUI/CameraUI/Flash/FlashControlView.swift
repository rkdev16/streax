...
public class FlashControlView: UIView {
    ...
    public let primaryLabel: UILabel = {
        let label = UILabel()
        label.text = "Flash"
//        CameraKitLocalizedString(key: "camera_kit_flash", comment: "")
    ...
    public lazy var flashModeSelectionView: FlashModeSelectionView = {
        ...
        view.accessibilityLabel = "Flash Mode Selector"
//        CameraKitLocalizedString(key: "camera_kit_flash_mode_selector", comment: "")
        view.delegate = self
        view.translatesAutoresizingMaskIntoConstraints = false
    ...
    public lazy var ringLightColorSelectionView: RingLightColorSelectionView = {
        ...
        view.accessibilityLabel = "Ring Light Color Selector"
//        CameraKitLocalizedString(key: "camera_kit_ring_light_color_selector", comment: "")
        view.delegate = self
        view.translatesAutoresizingMaskIntoConstraints = false
        view.isHidden = true
        view.alpha = 0
    ...
    private lazy var ringLightIntensitySlider: ControlSlider = {
        ...
        slider.accessibilityLabel = "Ring Light Intensity Slider"
//        CameraKitLocalizedString(key: "camera_kit_ring_light_intensity_slider", comment: "")
