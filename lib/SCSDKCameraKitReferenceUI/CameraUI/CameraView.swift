...
open class CameraView: UIView {
    ...
    public lazy var flashControlView: FlashControlView = {
        ...
        view.accessibilityLabel = "Flash Control"
//        CameraKitLocalizedString(key: "camera_kit_flash_control", comment: "")
        view.isHidden = true
        view.translatesAutoresizingMaskIntoConstraints = false
    ...
    public let toneMapControlView: AdjustmentControlView = {
        ...
        view.accessibilityLabel = "Tone Map Control" /*CameraKitLocalizedString(key: "camera_kit_tone_map_control", comment: "")*/
    ...
    public let portraitControlView: AdjustmentControlView = {
        ...
        view.accessibilityLabel = "Portrait Control" /*CameraKitLocalizedString(key: "camera_kit_portrait_control", comment: "")*/
