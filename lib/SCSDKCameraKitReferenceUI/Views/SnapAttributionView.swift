...
public class SnapAttributionView: UIView {
    ...
    public let poweredByLabel: UILabel = {
        ...
        label.text = "Powered by"/*CameraKitLocalizedString(key: "camera_kit_powered_by", comment: "")*/
        label.sizeToFit()
    ...
    private func commonInit() {
        ...
        accessibilityIdentifier = "Powered by Snapchat" /*CameraKitLocalizedString(key: "camera_kit_powered_by_snapchat", comment: "")*/
